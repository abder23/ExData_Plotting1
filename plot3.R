...
legend("topright", col=c("black","blue", "red"), legend=c("Sub_metering_1","Sub_metering_2", "Sub_metering_3"), text.width = strwidth("1,1,000"), lty = 1:1, xjust = 1, yjust = 0.5, cex=0.5, pt.cex = 1:3, lwd = 0.5, adj = c(0,0))
